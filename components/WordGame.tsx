...
const WordGame = (props: Props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-[220px] h-[168px] bg-[#F6F6F6] border-[#999999] border-solid">
      ...
      >
        ...
        />
        <button className="px-2 bg-white h-full font-[Pretendard] text-xs border-solid border-black border-[1.5px] rounded-md">
          입력
        </button>
      </form>
